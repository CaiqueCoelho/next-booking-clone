...
import { ChevronDownIcon, PaperAirplaneIcon, HomeIcon, ChatBubbleLeftIcon, PhoneIcon, PlayCircleIcon } from '@heroicons/react/20/solid'
...
const products = [
    ...
    },
    {
        ...
        description: 'Your customeers data will be safe and secure',
        href: '#',
                                ...
                                {products.map((item) => (
                                    ...
                                    >
                                        <div className='flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-gray-200'>
                                            <item.icon className='h-6 w-6 text-[#013B94] group-hover:text-gray-900' aria-hidden='true' 
                                        />
                                        </div>
                    ...
                    <div className='mt-6 flow-root'>
                        <div className='-my-6 divide-y divide-gray-500/10'>
                                <div className='space-y-2 py-6'>
                                    <Disclosure as="div" className="-mx-3">
                                        {({ open }) => (
                                            <>
                                                ...
                                                text-base font-semibold leading-7 hover:bg-blue-800 text-white'>
                                                    Stays
                                                    <ChevronDownIcon
                                    ...
                                    <a href='#' className='-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-white hover:bg-blue-800'>
                                        Flights
                                    </a>
                                    <a href='#' className='-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-white hover:bg-blue-800'>
                                        Car Rentals
                                    ...
                                    <div className='py-6'>
                                        <a href='#' className='-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-6 text-white hover:bg-blue-800'>
                                            Log in
                                        </a>
                                    </div>
                                </div>
